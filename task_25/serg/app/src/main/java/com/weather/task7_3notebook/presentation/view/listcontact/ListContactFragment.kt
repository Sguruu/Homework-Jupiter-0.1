package com.weather.task7_3notebook.presentation.view.listcontact
...
import com.weather.task7_3notebook.presentation.view.listcontact.adapter.ContactAdapter
import com.weather.task7_3notebook.presentation.view.listcontact.viewmodel.ListContactViewModel
...
class ListContactFragment : Fragment(R.layout.fragment_list) {
    ...
    private fun initObserve() {
        ...
        viewLifecycleOwner.lifecycleScope.launch {
            viewModel.filterContactsFlow.onEach {
                updateRecyclerView(it)
            }.collect()
        }
    }
