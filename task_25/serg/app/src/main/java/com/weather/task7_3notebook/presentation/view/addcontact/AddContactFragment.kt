package com.weather.task7_3notebook.presentation.view.addcontact
...
import com.weather.task7_3notebook.presentation.extensions.setSpinnerFocusable
import com.weather.task7_3notebook.presentation.view.addcontact.viewmodel.AddContactViewModel
                ...
                val jobAddContact = launch {
                    viewModel.addContact(
                        Contact(
                            ...
                            lastName,
                            numberPhone,
                            viewModel.citiesFlow.first()[binding.spinner.selectedItemPosition] // получить город по позиции
                        )
                    )
                }
                jobAddContact.join()
